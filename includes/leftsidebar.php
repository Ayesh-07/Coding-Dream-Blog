...
<?php if($_SESSION['utype']=='1'):?>
  <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="add-subadmins.php">Add subadmins</a></li>
                                    <li><a href="manage-subadmins.php">Manage subadmins</a></li>
                                </ul>
                            </li>
<?php endif;?>
  ...
  <li class="has_sub">
                                <a href="javascript:void(0);" class="waves-effect"><i class="mdi mdi-format-list-bulleted"></i> <span> Posts (Articles) </span> <span class="menu-arrow"></span></a>
                                <ul class="list-unstyled">
   ...
   <li class="has_sub">
                    ...
                    <div class="help-box">
                        ...
                        <p class=""><span class="text-custom">Email:</span> <br/> bc190408737@vu.edu.pk</p>
                    </div>
