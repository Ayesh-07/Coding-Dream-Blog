...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Coding Dream Blog | Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo"><span>CDB<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
